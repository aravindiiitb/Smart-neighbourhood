...
import com.example.sunshine.sunshine.adapter.NavDrawerListAdapter;
...
public class UserProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(user.is_admin && user.occupation.equals("timeline"))
    ...
    public void displayView(int position) {
        ...
        switch (position) {
            case 0:
                ...
                break;
            case 1:
                fragment = new CheckPollFragment ();
                break;
            case 2:
            ...
            case 6:
                ...
                break;
            case 7:
                if(user.occupation.equals("timeline"))
                    fragment = new ManageUsersFragment();
                else
                    fragment = new ManageRequestsFragment();
                break;
            /*case 8:
  ...
  /*
    public void displayPoll(int pollID){
    ...
    public ModelUser displayUserDetails(){
        ModelUser user = userLocalStore.getLoggedInUser();
        return user;
    }
}
